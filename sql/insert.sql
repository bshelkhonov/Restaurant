...
insert into hall_x_administrator (hall_id, administrator_id)
values (1, 1),
       (2, 1),
       (2, 2),
       (3, 4),
...
insert into cook_x_dish (cook_id, dish_id)
values (1, 1),
       (1, 4),
       (2, 4),
       (2, 2),
...
insert into product_x_dish (product_id, dish_id)
values (1, 1),
       (2, 3),
       (3, 2),
       (4, 1),
...
insert into customer_x_card(customer_id, card_id)
values (1, 1),
       (2, 2),
       (3, 3),
       (4, 4),
